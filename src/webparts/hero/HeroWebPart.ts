...
import { IHeroProps } from "./components/hero/IHeroProps";
...
export default class HeroWebPart extends BaseClientSideWebPart<IHeroWebPartProps> {
	...
	private readonly _environmentMessage: string = "";

	public render(): void {
		const element: React.ReactElement<IHeroProps> = React.createElement(Hero, {
	...
	protected async onInit(): Promise<void> {
		await super.onInit();
		PnpService.initialize(this.context);
	}
